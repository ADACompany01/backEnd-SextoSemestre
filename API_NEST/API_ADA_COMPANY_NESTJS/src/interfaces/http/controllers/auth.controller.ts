...
export class AuthController {
  ...
  @ApiOperation({
    summary: 'Registrar novo cliente (apenas clientes podem se cadastrar)',
  })
  @ApiBody({
    schema: {
      type: 'object',
      properties: {
        ...
        type: {
          ...
          example: 'client',
          description:
            'Apenas "client" é permitido. Funcionários não podem se cadastrar por este endpoint.',
        },
    ...
    description:
      'Dados do cliente. Funcionários devem ser cadastrados apenas por administradores autenticados.',
  })
  @ApiResponse({
    status: 201,
