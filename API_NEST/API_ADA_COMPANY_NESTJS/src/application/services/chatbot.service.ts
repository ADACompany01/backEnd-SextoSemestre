...
const CHATBOT_NODES: Record<string, ChatbotNode> = {
  ...
  atendente: {
    ...
    message: 'Vou te direcionar para um atendente especializado. Se preferir, faca login para acompanhar seus pedidos pelo painel.',
    options: [],
  ...
  wcag: {
    ...
    message: 'A WCAG organiza a acessibilidade em niveis A, AA e AAA. Recomendamos AA para a maioria dos sites e avaliamos criterios como contraste, navegacao por teclado, textos alternativos e estrutura semantica.',
    options: [],
  ...
  'tipos-site': {
    id: 'tipos-site',
    title: 'Tipos de Site',
    message: 'Desenvolvemos sites institucionais, portfolios, blogs, landing pages, paginas de servicos e experiencias acessiveis para diferentes publicos.',
    options: [],
  ...
  'recursos-site': {
    ...
    message: 'Os projetos podem incluir layout responsivo, boas praticas de acessibilidade, conteudo estruturado, formularios, integracoes, publicacao e suporte inicial.',
    options: [],
  ...
  'informar-dados': {
    ...
    message: 'Para montar seu orcamento, informe tipo de projeto, objetivo, publico, prazo, recursos desejados e dados de contato.',
    options: [],
  ...
  'sobre-sistema': {
    ...
    message: 'O sistema da AdaCompany centraliza solicitacoes, orcamentos, contratos e acompanhamento de projetos em um painel para clientes e equipe.',
    options: [],
  ...
  'planos-recursos': {
    ...
    message: 'Os planos variam conforme escopo, funcionalidades, integracoes, nivel de suporte e necessidades de acessibilidade do projeto.',
    options: [],
    action: { type: 'navigate', label: 'Solicitar proposta', url: '/signuporcamento' },
  },
  'duvidas-tecnicas': {
    ...
    message: 'Podemos ajudar com duvidas de uso, funcionamento, acessibilidade, desempenho, integracoes e manutencao.',
    options: [],
  ...
  'manutencao-suporte': {
    ...
    message: 'Nosso suporte ajuda com ajustes, atualizacoes, correcao de problemas, melhoria de acessibilidade e acompanhamento tecnico.',
    options: [],
  ...
  treinamentos: {
    ...
    message: 'Oferecemos orientacoes para uso do sistema, boas praticas de conteudo acessivel e tutoriais para administrar seu projeto.',
    options: [],
    action: { type: 'finish', label: 'Encerrar atendimento' },
  },
  integracoes: {
    ...
    message: 'Avaliamos integracoes com formularios, automacoes, ferramentas externas, area do cliente e recursos especificos do seu negocio.',
    options: [],
